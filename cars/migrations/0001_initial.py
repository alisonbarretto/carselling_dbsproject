# Generated by Django 3.0.7 on 2022-03-02 12:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_photo_1', models.ImageField(blank=True, upload_to='phoyos/%Y/%m/%d/')),
                ('car_photo_2', models.ImageField(blank=True, upload_to='phoyos/%Y/%m/%d/')),
                ('car_photo_3', models.ImageField(blank=True, upload_to='phoyos/%Y/%m/%d/')),
                ('car_photo_4', models.ImageField(blank=True, upload_to='phoyos/%Y/%m/%d/')),
