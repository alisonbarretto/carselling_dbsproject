...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, 'Already made a request about this car, please wait until we get back to you.')
        ...
        contact.save()
        messages.success(request, 'Request has been submitted, we will get back to you shortly.')
        return redirect('/cars/'+car_id)